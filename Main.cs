...
namespace Menu
{
    ...
    public class Main : MonoBehaviour
    {
        ...
        public static void CreateMenu()
        {
            ...
            menuBackground.GetComponent<Renderer>().material.color = Color.gray2;
                ...
                transform =
        {
            ...
            gameObject.GetComponent<Renderer>().material.color = Color.gray1;
        ...
        public static void CreateButton(float offset, ButtonInfo method)
        {
            ...
            ButtonOutline.GetComponent<Renderer>().material.color = Color.black;
